    ...
    <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">+{stats.recentActivity.newUsersThisMonth} ce mois</p>
            </CardContent>
          </Card>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Spectateurs</CardTitle>
              <Users className="h-4 w-4 text-blue-600" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-blue-600">{stats.totalSpectateurs}</div>
              <p className="text-xs text-muted-foreground">
                {((stats.totalSpectateurs / stats.totalUsers) * 100).toFixed(1)}% du total
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{stats.totalGestionnaires}</div>
              <p className="text-xs text-muted-foreground">
                {((stats.totalGestionnaires / stats.totalUsers) * 100).toFixed(1)}% du total
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">
                {((stats.totalAdmins / stats.totalUsers) * 100).toFixed(1)}% du total
              </p>
            </CardContent>
          </Card>
        </div>
